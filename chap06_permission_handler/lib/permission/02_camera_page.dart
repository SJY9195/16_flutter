...
class _CameraPermissionPageState extends State<CameraPermissionPage> {
  File? _image; // 선택된 이미지 파일을 저장할 변수.  // ?의 역할 : 값이 들어가기 전에 null을 넣어준다.
  ...
  /*
  * CircularProgressIndicator() // 로딩 중 원형 모양
  *
  * */
  ...
  Widget build(BuildContext context) {
    return Center(
      child: Column(
        ...
        children: [
          _image == null ? Text("사진을 선택하세요") : Image.file(_image!),  //!는 null이 아니라고 선언해주는것!
          SizedBox(height: 20,),
          // 갤러리에서 선택하는 버튼
          ElevatedButton(
